...
```bash
# Clone the project
git clone git@github.com:go-vela/vela-manifest-tool.git $HOME/go-vela/vela-manifest-tool
```
...
cd $HOME/go-vela/vela-manifest-tool
```
...
git remote add fork https://github.com/your_fork/vela-manifest-tool
```
